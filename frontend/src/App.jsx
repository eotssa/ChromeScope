...
const instructions = (
  <div className="instructions">
    ...
    <ol>
      <li>
        Navigate to the Chrome Web Store and find the extension you want to
        analyze.
      </li>
      <li>
        Copy the extension's link and visit{" "}
        <a
          href="https://crxextractor.com"
          target="_blank"
      ...
      <li>
        Replace "https://chromewebstore.google.com/" in the copied URL with
        "https://chrome.google.com/webstore".
      </li>
      <li>Download the .crx file from the updated link.</li>
      <li>
        Use CRX Extractor to get the source code by uploading the .crx file.
      </li>
